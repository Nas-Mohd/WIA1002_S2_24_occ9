...
class WeightedGraph<T extends Comparable<T>, N extends Comparable <N>> {
   ...
   public boolean addUndirectedEdge(Vertex<T,N> v1, Vertex<T,N> v2, N weight){
      if (head == null)
         return false;
      
      if(hasVertex(v1.vInfo) && hasVertex(v2.vInfo)){
         addEdge(v1.vInfo, v2.vInfo, weight);
         addEdge(v2.vInfo, v1.vInfo, weight);
      }
